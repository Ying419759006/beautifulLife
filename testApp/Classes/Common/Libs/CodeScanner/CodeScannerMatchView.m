...
@implementation CodeScannerMatchView {
    BOOL _set;
...
//        self.matchFoundColor = [UIColor redColor];  //识别到的二维码包裹框
        self.scanningColor = [UIColor clearColor];
//        self.scanningColor = [UIColor whiteColor];  //扫描动画框
